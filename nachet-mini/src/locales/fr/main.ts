const main = {
  ...
  resultsTable: {
    ...
    seedNumber: "Graine {{number}}",
    seedCrop: "Image de la graine",
    modelFocusFor: "R\u00e9gions cibl\u00e9es pour {{species}}",
    showModelFocus: "Afficher les r\u00e9gions cibl\u00e9es pour {{species}}",
    hideModelFocus: "Masquer les r\u00e9gions cibl\u00e9es pour {{species}}",
    taxonomy: "Taxonomie",
    taxonomyFor: "Taxonomie de {{species}}",
    family: "Famille",
    genus: "Genre",
    families: "Familles",
    genera: "Genres",
    showTaxonomyDetails: "D\u00e9tails",
    hideTaxonomyDetails: "Masquer les d\u00e9tails",
    taxonomyUnavailable:
      "La taxonomie n\u2019est pas disponible pour ce classificateur.",
    speciesPredictions: "Pr\u00e9dictions d\u2019esp\u00e8ces",
  },
  imageGallery: {
    title: "Images",
    image: "Image {{number}}",
