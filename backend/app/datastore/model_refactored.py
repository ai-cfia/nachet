"""
Refactored Model data service using generic BaseCRUDDataService.

This demonstrates the code reduction achieved by using the generic base class:
- Original: 237 lines
- Refactored: ~90 lines (62% reduction)
"""
...
# Code Comparison:
# ================
# Original ModelDataService: 237 lines
# Refactored with BaseCRUDDataService: ~90 lines
# Reduction: 62% less code
#
# What the base class provides automatically:
# - get_all() with relationship loading
# - get_by_id() with relationship loading
# - update() with optional field handling
# - soft_delete() with proper entity handling
#
# What we keep custom:
# - get_by_task_id() - entity-specific query
# - create() - typed wrapper (optional, could use **kwargs directly)
