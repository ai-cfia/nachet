...
async def validate_orm_classes_async(debug: bool = False):
    ...
    try:
        ...
        print(f"Using async DB URL: {db_url}" if debug else "Using async DB URL: [HIDDEN]")
...
if __name__ == "__main__":
    ...
    print(f"Overall result: {'✅ ALL TESTS PASSED' if sync_valid and async_valid else '❌ SOME TESTS FAILED'}")
    print("=" * 50)
