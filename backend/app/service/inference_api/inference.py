        ...
        for i, box in enumerate(boxes):
            for j, box2 in enumerate(boxes):
                if j > i:
                    ...
                    if (
                        common_area >= area_box * area_ratio
            ...
            for j in range(i + 1, len(api_boxes)):
                ...
                if (
                    ...
                    if api_boxes[j].score < api_boxes[i].score:
                        ...
                        api_boxes[
                            j
                        ].overlappingIndices = i  # Store index of higher-score box
                        ...
                        api_boxes[
                            i
                        ].overlappingIndices = j  # Store index of higher-score box
                        # Update pixel coordinates to match higher-score box
